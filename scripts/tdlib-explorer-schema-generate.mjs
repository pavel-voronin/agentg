...
import { TD_LIB_SCHEMA_COMMIT, TD_LIB_SCHEMA_URL } from './tdlib/schema-source.mjs';

const ROOT = new URL('../', import.meta.url);
const OUT_FILE = new URL('packages/telegram/src/tdlib-docs/data/tdlib-schema.json', ROOT);
