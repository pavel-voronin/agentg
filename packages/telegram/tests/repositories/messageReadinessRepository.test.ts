...
import type { MessageReadRequest } from '../../src/domain/models/messageSelection.js';
...
vi.mock('../../src/storage/reconcilerCoverageStorage.js', () => ({
  isOwnerCovered: coverage.isOwnerCovered,
  missingOwnerCoverageIntervals: coverage.missingOwnerCoverageIntervals
}));

vi.mock('../../src/storage/messageReadStorage.js', () => read);

import { checkMessagesReadiness } from '../../src/repositories/messageReadinessRepository.js';
...
function latestPageInput(): MessageReadRequest {
  return {
    owner: {
      chatId: '123',
      kind: 'chat'
