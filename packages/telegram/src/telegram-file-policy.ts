...
} from './telegram-file-policy-rules.js';
import type { ExtractedTelegramFileSlot } from './telegram-file-types.js';
...
export type { TelegramMediaDownloadPolicyCause } from './telegram-file-policy-rules.js';
