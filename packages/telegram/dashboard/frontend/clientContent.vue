...
import type { ChatListMode, DashboardChat, TelegramDirectoryChat } from './views.js';
import {
  buildChatHeaderView,
  buildChatNavigation,
  chatListFilter,
...
const chats = computed<DashboardChat[]>(() => dashboardChats(visibleDirectoryChats.value));
