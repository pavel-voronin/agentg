...
- Tests in this package cover runner-specific wiring only.
- Registry behavior tests belong to `@agentg/framework`.
- Do not reintroduce local registry, client, or contract tests here.
