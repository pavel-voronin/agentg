...
<template>
  <div v-if="view" class="history-timeline">
    <div class="history-timeline__track-row">
      <div class="history-timeline__toggle-shell">
        <button
          class="history-timeline__toggle"
        ...
        >
          <svg
            class="history-timeline__toggle-icon"
            viewBox="0 0 16 16"
            fill="none"
            stroke="currentColor"
            stroke-width="2"
    ...
    <div v-if="view.detailsEmpty" class="history-timeline__empty">
