...
export const moduleDefinition = defineModule('data', {
  ...
  setup({ config, resource }) {
    ...
    return {
      ...
      browseAnnotations: (input: unknown) => runtime.browseAnnotations(input),
      browseCollection: (input: unknown) => runtime.browseCollection(input),
      ...
      selectPage: (input: unknown) => runtime.selectPage(input),
