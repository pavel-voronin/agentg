...
Templates are not executed directly. They materialize concrete `HistoryTarget`
objects for concrete chats.

## HistoryTarget

`HistoryTarget` is desired Telegram history coverage for one concrete chat.
